$(function() {
   ...
   ========================================================================== */
    ...
    $('.tweet').twittie({
        username: 'otaviopadovani', // change username here
        dateFormat: '%b. %d, %Y',
   ...
   ========================================================================== */
    ...
    $('.faq-section .menu li').on('click', function() {
        var menuLiIndex = $(".faq-section .menu li" ).index( this );

        $('.faq-section .menu li').removeClass('selected');
        $('.faq-section ol li').removeClass('selected');      

        $(this).addClass('selected');
        $.each($('.faq-section ol li'), function( i, v ) {
            if(menuLiIndex == i)
                $(this).addClass('selected');
            //alert( "Key: " + i + ", Value: " + v );
        });
